        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    {{-- Error messaged to be dispalyed that we wrote in the RegisterController.php file --}}
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="username" name="username" id="username" placeholder="Your username" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username') }}">
                    @error('username')
                    <div class="text-red-500 mt-2 text-sm">
                        {{ $message }}
                    </div>
